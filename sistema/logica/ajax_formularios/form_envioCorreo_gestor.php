<?php 
    ...
    if ( empty($_POST['user'])) {
    ...
    else if (empty($_POST['observaciones']) || empty($_POST['estado'])
                ) {
                    $alert="<script>
                    Swal.fire({
                        icon: 'error',
        ...
        $insertSsql = "UPDATE envioCorreo_registros SET fechaCierre = STR_TO_DATE('$fechaRegistro', '%d/%m/%Y'),
                                                        horaCierre = '$horaRegistro',
                                                        observaciones = CONCAT(observaciones, '$observaciones //'),
                                                        id_estado = '$estado',
                                                        id_userCierra = '$userRegistra'
