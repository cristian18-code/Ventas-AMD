$(document).ready(function(){
    ...
    $("#form_envioCorreo_gestor").on("submit",function(e){
        e.preventDefault();


        var parametros = new FormData($("#form_envioCorreo_gestor")[0]);
        var btnEnviar = $("#btnEnviar_envioCorreo_gestor");
        ...
        if (estado == null || estado == 0) {
            ...
            $("#estado").css("border-color", "#ced4da");
        }
        ...
        const swalWithBootstrapButtons = Swal.mixin({
          ...
          swalWithBootstrapButtons.fire({
            ...
            $.ajax({
                data:parametros,
                url:"././sistema/logica/ajax_formularios/form_envioCorreo_gestor.php",
                type:"POST",
                contentType:false,
                processData:false,
                success: function(data){
                    ...
                    $("body").append(data);
                    setTimeout(function () {
                      window.location.href = "./././tabla_correos.php";
                    }, 4000); //hace redireccion despues de 4 segundos
                },
